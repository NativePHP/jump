        ...
        <column class="w-full px-6 pb-16 pt-4 gap-6">
            <row class="w-full items-center justify-between">
                ...
                <pressable @press="closeHow">
                    <native:icon :ios="App\Icons\Ios::XmarkCircleFill" :android="App\Icons\Android::Cancel" :size="28"
            ...
            @foreach ([
                ...
                <row class="w-full items-start gap-4">
                    ...
                    <column class="flex-1 gap-1">
                        <text class="text-xs font-bold text-theme-primary tracking-widest">STEP {{ $step['n'] }}</text>
