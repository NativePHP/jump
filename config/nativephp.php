    ...
    'android' => [
        ...
        */
        'build' => [
            ...
            // Plugin keep rules are auto-generated by the plugin compiler
            // (and plugins declare extras via android.proguard_rules in
            // nativephp.json) — this is only for app-specific rules.
